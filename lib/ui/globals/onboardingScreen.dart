                              ...
                              Padding(
                                  ...
                                  child:  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text("Trouvez facilement un technicien près de chez vous!",
                                        style: TextStyle(
                                          color: BLACK_COLOR,
                                          fontSize: 20,
                                        ),
                              ...
                              Padding(
                                  ...
                                  child:  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text("Des avis de nombreuses personnes pour vous aider à choisir le meilleur.",
                                        style: TextStyle(
                                          color: BLACK_COLOR,
                                          fontSize: 20,
                                        ),
                              ...
                              Padding(
                                  ...
                                  child:  Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text("Trouvez des astuces pour rendre vos journées plus aisées.",
                                        style: TextStyle(
                                          color: BLACK_COLOR,
                                          fontSize: 20,
                                        ),
