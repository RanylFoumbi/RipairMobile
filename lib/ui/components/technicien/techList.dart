        ...
        : (_techList == null || _techList.length == 0)
            ...
            : GridView.builder(
                ...
                itemBuilder: (context, index) {
                  var nbrOfStar = _techList[index]['rating'].length == 0
                      ? 0
                      : (_techList[index]['rating']
                              .reduce((curr, next) => curr + next)) /
                          _techList[index]['rating'].length;
                  return GestureDetector(
                    ...
                    child: Container(
                        margin: EdgeInsets.only(
                            top: 8, bottom: 4, left: 12, right: 5),
                        ...
                        child: Column(children: <Widget>[
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              _techList[index]['name'] +
                                  " " +
                                  _techList[index]['lastname'],
                              maxLines: 1,
