...
class _AstuceHomeScreenState extends State<AstuceHomeScreen>
          ...
          : (_astuceList == null || _astuceList.length == 0)
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, index) {
                    var nbrOfStar = _astuceList[index].rating.length == 0
                        ? 0
                        : (_astuceList[index]
                                .rating
                                .reduce((curr, next) => curr + next)) /
                            _astuceList[index].rating.length;
