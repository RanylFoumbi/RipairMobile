...
class _HomeState extends State<Home> {
        ...
        if (astuceSnap.hasError)
          ...
          return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                var nbrOfStar = astuceSnap.data[index]['rating'].length == 0
                    ? 0
                    : (astuceSnap.data[index]['rating']
                            .reduce((curr, next) => curr + next)) /
                        astuceSnap.data[index]['rating'].length;
                var convertedStar = nbrOfStar.toString().length >= 4
                    ? nbrOfStar.toString().substring(0, 3)
                    : nbrOfStar.toString();
                return GestureDetector(
                  ...
                  child: Container(
                      margin: EdgeInsets.only(
                          top: 8, bottom: 2, left: 15, right: 3),
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        colorFilter: ColorFilter.mode(
                                            BLACK_COLOR.withOpacity(0.35),
                                            BlendMode.overlay),
                                        image: new NetworkImage(astuceSnap
                                            .data[index]['images'][0]),
                                        fit: BoxFit.cover)),
  ...
  Widget _getTechnician(town) {
    return FutureBuilder(
      builder: (context, techSnap) {
        ...
        if (techSnap.hasError)
          ...
          return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                var nbrOfStar = techSnap.data[index]['rating'].length == 0
                    ? 0
                    : (techSnap.data[index]['rating']
                            .reduce((curr, next) => curr + next)) /
                        techSnap.data[index]['rating'].length;
                ...
                return GestureDetector(
                    ...
                    Navigator.push(
                        ...
                        PageTransition(
                            ...
                            child: TechnicianDetails(
                              ...
                              nbrOfComment: techSnap.data[index]
                                  ['nbrOfComment'],
                              numberOfStars: nbrOfStar.toString().length >= 4
                                  ? nbrOfStar.toString().substring(0, 3)
                                  : nbrOfStar.toString(),
                            )));
                  },
                  child: Container(
                      margin: EdgeInsets.only(
                          top: 4, bottom: 2, left: 12, right: 5),
                      decoration: BoxDecoration(
                          color: WHITE_COLOR,
                          borderRadius: BorderRadius.circular(15),
                          boxShadow: [
                      ...
                      child: Column(children: <Widget>[
                        ...
                        SizedBox(
                          ...
                          child: Text(
                            techSnap.data[index]['name'] +
                                " " +
                                techSnap.data[index]['lastname'],
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            softWrap: true,
                            style: TextStyle(
      ...
      future: town == "recent"
          ? UserApi().fetchMostRecentTech()
          : UserApi().fetchBestTech(town),
    );
  }
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        child: Text(
                          "voir plus",
                          style: TextStyle(color: BLUE_COLOR, fontSize: 13),
                        ),
                        onTap: null,
                      ),
                    ],
